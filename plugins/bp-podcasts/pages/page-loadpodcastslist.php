...
<div class="wrap">
	<div id="primary" class="content-area">
      ...
      <?php if (is_user_logged_in()) : ?>
            ...
            <p><em>Este processo pode demorar um pouco se os podcasts da sua lista não estiverem cadastrados no nosso banco de dados.</em></p>
            ...
            <br/><br /><input id="opml_send_button" type="submit" value="Enviar">
            <div id="opml_loading" style=""><img style="width: 1em; margin: 0 0.3em;" src="<?php echo plugin_dir_url( __FILE__ ) . '../images/Loading_icon.gif' ?>" /> Aguarde. Carregando podcasts</div>
      <?php else : ?>
